...
const ProductsList = () => {
	...
	return (
		<motion.div
			className='bg-gray-200 shadow-lg rounded-lg overflow-hidden max-w-4xl mx-auto'
				...
				<tbody className='bg-gray-300 divide-y divide-gray-200'>
					{products?.map((product) => (
						<tr key={product._id} className='hover:bg-gray-400'>
							...
							<td className='px-6 py-4 whitespace-nowrap'>
								<div className='text-sm text-black'>{product.price.toLocaleString('vi-VN')} VND</div>
							</td>
							<td className='px-6 py-4 whitespace-nowrap'>
